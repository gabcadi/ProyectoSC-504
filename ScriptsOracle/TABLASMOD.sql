...
) TABLESPACE FIDE_PROYECTOFINAL_TBS;
...
AUDIT INSERT, UPDATE, DELETE ON FIDE_PROYECTO_FINAL_USUARIO_ADMIN.FIDE_ESPECIALIZACION_DOCENTE_TB BY ACCESS;
AUDIT INSERT, UPDATE, DELETE ON FIDE_PROYECTO_FINAL_USUARIO_ADMIN.FIDE_USUARIO_TB BY ACCESS;
AUDIT INSERT, UPDATE, DELETE ON FIDE_PROYECTO_FINAL_USUARIO_ADMIN.FIDE_CURSO_TB BY ACCESS;
AUDIT INSERT, UPDATE, DELETE ON FIDE_PROYECTO_FINAL_USUARIO_ADMIN.FIDE_HORARIO_TB BY ACCESS;
AUDIT INSERT, UPDATE, DELETE ON FIDE_PROYECTO_FINAL_USUARIO_ADMIN.FIDE_CURSO_HORARIO_TB BY ACCESS;
AUDIT INSERT, UPDATE, DELETE ON FIDE_PROYECTO_FINAL_USUARIO_ADMIN.FIDE_CURSO_RELACIONADO_TB BY ACCESS;
AUDIT INSERT, UPDATE, DELETE ON FIDE_PROYECTO_FINAL_USUARIO_ADMIN.FIDE_ASIGNACION_DOCENTE_TB BY ACCESS;
AUDIT INSERT, UPDATE, DELETE ON FIDE_PROYECTO_FINAL_USUARIO_ADMIN.FIDE_AULAS_TB BY ACCESS;
AUDIT INSERT, UPDATE, DELETE ON FIDE_PROYECTO_FINAL_USUARIO_ADMIN.FIDE_CURSO_AULA_TB BY ACCESS;
AUDIT INSERT, UPDATE, DELETE ON FIDE_PROYECTO_FINAL_USUARIO_ADMIN.FIDE_PLAN_ESTUDIOS_TB BY ACCESS;
AUDIT INSERT, UPDATE, DELETE ON FIDE_PROYECTO_FINAL_USUARIO_ADMIN.FIDE_CURSOS_PLAN_TB BY ACCESS;
AUDIT INSERT, UPDATE, DELETE ON FIDE_PROYECTO_FINAL_USUARIO_ADMIN.FIDE_HISTORIAL_ACADEMICO_TB BY ACCESS;
AUDIT INSERT, UPDATE, DELETE ON FIDE_PROYECTO_FINAL_USUARIO_ADMIN.FIDE_NOTIFICACIONES_TB BY ACCESS;
AUDIT INSERT, UPDATE, DELETE ON FIDE_PROYECTO_FINAL_USUARIO_ADMIN.FIDE_HORARIO_MATRICULADO_TB BY ACCESS;